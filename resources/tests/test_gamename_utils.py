...
class TestGamenameUtils(unittest.TestCase):
    ...
    def test_normalizeName(self):
        ...
        self.assertEquals('MADDENNFL97', x)
        x = gnu.normalize_name("Lemmings 2: The Tribes")
        self.assertEquals('LEMMINGS2TRIBES', x)
        x = gnu.normalize_name("Lemmings 2 - The Tribes")
        self.assertEquals('LEMMINGS2TRIBES', x)
    ...
    def test_prepare_gamename_for_webrequest(self):
        ...
        result = gnu.prepare_gamename_for_webrequest("Chrono Trigger (USA)")
        self.assertEqual(result, "Chrono Trigger")
        result = gnu.prepare_gamename_for_webrequest("Chrono Trigger [cr TCS] (USA)")
        self.assertEqual(result, "Chrono Trigger")
        result = gnu.prepare_gamename_for_webrequest("Crash Bandicoot 2: Cortex Strikes Back")
        self.assertEqual(result, "Crash Bandicoot")
        result = gnu.prepare_gamename_for_webrequest("Crash Bandicoot 2")
        self.assertEqual(result, "Crash Bandicoot")
        result = gnu.prepare_gamename_for_webrequest("Crash Bandicoot II: Cortex Strikes Back")
        self.assertEqual(result, "Crash Bandicoot")
        result = gnu.prepare_gamename_for_webrequest("Crash Bandicoot II")
        self.assertEqual(result, "Crash Bandicoot")
        result = gnu.prepare_gamename_for_webrequest("Super Mario World 2 - Yoshi's Island (USA)")
        self.assertEqual(result, "Super Mario World")
        result = gnu.prepare_gamename_for_webrequest("Madden NFL '97 (USA)")
        self.assertEqual(result, "Madden NFL")
        result = gnu.prepare_gamename_for_webrequest("Legend of Zelda, The - A Link to the Past (USA)")
        self.assertEqual(result, "Legend of Zelda")
        result = gnu.prepare_gamename_for_webrequest("FIFA '98: Road to Worldcup (1998) [Electronic Arts]")
        self.assertEqual("FIFA", result)
        result = gnu.prepare_gamename_for_webrequest("FIFA '98 (1998) [Electronic Arts]")
        self.assertEqual("FIFA", result)
        result = gnu.prepare_gamename_for_webrequest("FIFA '98: Road to Worldcup")
        self.assertEqual("FIFA", result)
        result = gnu.prepare_gamename_for_webrequest("3 Ninjas kick back")
