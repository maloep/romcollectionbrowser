...
consoleDict = {
			...
			'Atari Jaguar' : ['17', 'Atari Jaguar', 'jaguar'],
			'Atari Lynx' : ['18', '', 'lynx'],
			'Atari ST' : ['24', '', 'ast'],
			'BBC Micro' : ['92', '', 'bbc'],
			'BREW' : ['63', '', ''],
			...
			'Sega Dreamcast' : ['8', 'Sega Dreamcast', 'dreamcast'],
			'Sega Game Gear' : ['25', 'Sega Game Gear', 'gamegear'],
			'Sega Genesis' : ['16', 'Sega Genesis', 'genesis'],
			...
			'Zeebo' : ['88', '', ''],
			'Zodiac' : ['68', '', 'zod'],
			'ZX Spectrum' : ['41', 'Sinclair ZX Spectrum', '']}
