...
def main():
        ...
        results = dp.parseDescription('E:\\Emulatoren\\data\\Testdata V0.3\\Collection V3\\description\\synopsis.txt', 
                'E:\\Emulatoren\\data\\Testdata V0.3\\Collection V3\\parserConfig.xml', '')
