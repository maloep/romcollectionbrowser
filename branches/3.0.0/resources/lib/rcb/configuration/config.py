...
INDEX_GIANTBOMB = 3
consoleDict = {
			#name, mobygames-id, thegamesdb, archive vg, giantbomb.com
			'Other' : ['0', '', '', ''],
			'3DO' : ['35', '3DO', '3do', '26'],
			'Amiga' : ['19', 'Amiga', 'amiga', '1'],
			'Amiga CD32' : ['56', '', 'cd32', '39'],
			'Amstrad CPC' : ['60', 'Amstrad CPC', 'cpc', '11'],
			'Android' : ['', '', '', '123'],
			'Apple II' : ['31', '', 'appleii', '12'],
			'Apple IIgs' : ['', '', '', '38'],
			'Atari 2600' : ['28', 'Atari 2600', 'atari2600', '40'],
			'Atari 5200' : ['33', 'Atari 5200', 'atari5200', '67'],
			'Atari 7800' : ['34', 'Atari 7800', 'atari7800', '70'],
			...
			'ColecoVision' : ['29', 'Colecovision', 'colecovision', '47'],
			'Commodore 128' : ['61', '', '', '58'],
			'Commodore 16' : ['', '', '', '150'],
			...
			'Game Boy Advance' : ['12', 'Nintendo Gameboy Advance', 'gba', '4'],  
			...
			'Genesis' : ['16', 'Sega Genesis', 'genesis', '6'],
			'Gizmondo' : ['55', '', 'gizmondo', '78'],
			'Intellivision' : ['30', 'Intellivision', 'intellivision', '51'],
			'iPhone' : ['', '', '', '96'],			
			...
			'PSP' : ['46', 'Sony PSP', '', '18'],
			'SEGA 32X' : ['21', 'Sega 32X', 'sega32x', '31'],  
			'SEGA CD' : ['20', 'Sega CD', 'segacd', '29'],
			'SEGA Master System' : ['26', 'Sega Master System', 'sms', '8'],  
			...
			'TRS-80' : ['58', '', '', '63'],
			'TRS-80 CoCo' : ['62', '', '', '68'],  
			'TurboGrafx-16' : ['40', 'TurboGrafx 16', 'tg16', '55'],
			'TurboGrafx CD' : ['45', '', '', '53'],
			'Vectrex' : ['37', '', 'vectrex', '76'],
			'VIC-20' : ['43', '', 'vic20', '30'],
			'Virtual Boy' : ['38', 'Nintendo Virtual Boy', 'virtualboy', '79'],  
			'V.Smile' : ['42', '', '', '82'],
			...
			'Xbox' : ['13', 'Microsoft Xbox', 'xbox', '32'],
